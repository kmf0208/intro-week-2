...
console.log(makeAllUpperCase(["a", "b", "c"]));
...
console.log(collectStrings(["a", 10, "b", 1000, "d"]));
...
console.log(collectPlurals(["dogs", "cat", "apples", "kittens", "kiwi"]));
